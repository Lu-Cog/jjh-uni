			...
			<view class='personal-data'>
				...
				<view class='list'>
					<view class='item acea-row row-between-wrapper'>
						...
						<button class="avatar-box" open-type="chooseAvatar" @chooseavatar="onChooseAvatar"><image :src="userInfo.avatar"></image></button>
					</view>
					<view class='item acea-row row-between-wrapper'>
						<view>昵称</view>
						<view class='input'><input type='nickname' name='nickname' :value='userInfo.nickname'></input></view>
					</view>
					<view class='item acea-row row-between-wrapper'>
						<view>手机号码</view>
